...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $productId = $productModel->getProductByCategoryId($id);
}
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-primary mt-auto" href="../View/product-detail.php?id=<?php echo $product['id']  ?>">Chi tiết sản phẩm</a></div>
                            </div>
                        </div>
                    </div>
                <?php
