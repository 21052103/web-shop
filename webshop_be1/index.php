...
<body>
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    <li class="nav-item"><a class="nav-link active" aria-current="page" href="index.php" class="trangchu">Home</a></li>
                    ...
                    <!-- Search Form -->
                    <li>
                        <form action="./App/View/product-search.php" class="d-flex" role="search" method='get'>
                ...
                <form action="./App/View/product-cart.php" class="d-flex">
                ...
                ?>
                    <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="./App/View/image/<?php echo $product['image'] ?>" alt="..." />
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn btn-outline-primary mt-auto" href="./App/View/product-detail.php?id=<?php echo $product['id'] ?>">
    ...
    <footer class="py-5 bg-info">
        <div class="container">
            <p class="m-0 text-center text-white">Shop siêu cute đáng iuuu</p>
        </div>
    </footer>
    <!-- Bootstrap core JS-->
